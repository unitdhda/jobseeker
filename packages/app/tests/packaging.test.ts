...
test('published app and reference deployment pin version 0.2.7 consistently', async () => {
  ...
  assert.equal(app.version, '0.2.7'); assert.equal(deployment.version, app.version);
