...
test('published app and reference deployment pin version 0.2.0 consistently', async () => {
  ...
  assert.equal(app.version, '0.2.0'); assert.equal(deployment.version, app.version);
