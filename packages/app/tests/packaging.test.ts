...
test('published app and reference deployment pin version 0.2.1 consistently', async () => {
  ...
  assert.equal(app.version, '0.2.1'); assert.equal(deployment.version, app.version);
