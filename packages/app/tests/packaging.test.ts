...
test('published app and reference deployment pin version 0.2.10 consistently', async () => {
  ...
  assert.equal(app.version, '0.2.10'); assert.equal(deployment.version, app.version);
