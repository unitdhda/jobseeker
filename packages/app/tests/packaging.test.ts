...
test('published app and reference deployment pin version 0.2.9 consistently', async () => {
  ...
  assert.equal(app.version, '0.2.9'); assert.equal(deployment.version, app.version);
